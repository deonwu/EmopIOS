//
//  BaseComplexTableViewController.h
//  zaol
//
...
@interface BaseComplexTableViewController : BaseViewController<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
{
    struct {
